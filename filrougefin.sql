...
(12,  'DECLAN', 'Richard', 'Appartement 870-7677 Magna Av.', '42980', 'Dornbirn', 'Mauris@amet.ca', 0102030405, '$2y$10$BBFFx.lzX3Ch6IUnVt5he.xwKhZ2k0c5FJVpbn00ylZ...', '2020-05-05',14),
...
(3,69881,'2019-07-30','total','2018-12-20','9969 Aliquet Route Coevorden 40616'),
...
--créer un utilisateur visiteur qui peut voir les produits
CREATE ROLE 'Rvisiteur';

GRANT SELECT
ON filrouge.produits
TO Rvisiteur;



SHOW GRANTS FOR Rvisiteur;

CREATE USER IF NOT EXISTS 'Visteur'@'localhost'
IDENTIFIED BY 'abcd';

GRANT Rvisiteur
TO 'Visiteur'@'localhost';

SHOW GRANTS FOR 'Visiteur'@'localhost';

SET DEFAULT ROLE Rvisiteur
TO 'Visiteur'@'localhost';

-- céer un utilisateur client :lecture sur toute la base (insertion et mise à jour dans commande et client)
CREATE ROLE 'Rclient';
...
GRANT update
ON filrouge.commandes,clients
to Rclient;

GRANTE insert
ON filrouge.commandes,clientsc,
to Rclient;

SHOW GRANTS FOR Rclient;
...
SET DEFAULT ROLE Rclient
TO 'client'@'localhost';


--céer utilisateur Profil gestion : lecture/écriture dans la base

CREATE ROLE 'Rgestion';
...
SHOW GRANTS FOR Rgestion;

CREATE USER IF NOT EXISTS 'gestion'@'localhost'
IDENTIFIED BY '1234';

GRANT Rgestion
TO 'gestion'@'localhost';

SHOW GRANTS FOR 'gestion'@'localhost';

SET DEFAULT ROLE Rgestion
TO 'gestion'@'localhost';
